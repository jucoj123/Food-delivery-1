<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <Number label="Sotreid" v-model="item.sotreid" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="Prefernece" v-model="item.prefernece" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
